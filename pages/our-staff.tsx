...
const OurStaff = () => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://cdn.contentful.com/spaces/${PRIVATE_DATA.spaseID}/entries?content_type=jerseyBehavioralCareCounselors&access_token=${PRIVATE_DATA.accessId}`,
      )
      .then((response) => {
    ...
    axios
      .get(
        `https://cdn.contentful.com/spaces/${PRIVATE_DATA.spaseID}/entries?content_type=jerseyBehavioralCarePrescribers&access_token=${PRIVATE_DATA.accessId}`,
      )
      .then((response) => {
  ...
  return (
    <>
      <Head>
        <title>
          Jersey Behavioral Care Mental Health Clinic - Call Today | Our Staff
        </title>
      </Head>
      <OtherHeader />
      <WrapperHeader
